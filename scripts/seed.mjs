...
const SEED_USERS = [
  {
    ...
    profile: {
      ...
      personality: { leadership: 6, creativity: 8, execution: 7, analytical: 5, communication: 8 },
  ...
  },
  {
    ...
    profile: {
      ...
      personality: { leadership: 8, creativity: 6, execution: 9, analytical: 8, communication: 9 },
      // current_situation: 'has_project_need_member',
  ...
  },
  {
    ...
    profile: {
      ...
      skills: [
        { name: 'Python', level: '상' },
        { name: 'PyTorch', level: '상' },
        { name: 'LangChain', level: '중' },
        { name: 'FastAPI', level: '중' },
        { name: 'Docker', level: '중' },
      ],
      personality: { leadership: 4, creativity: 7, execution: 8, analytical: 10, communication: 5 },
      // current_situation: 'has_project_need_member',
  ...
  },
  {
    ...
    profile: {
      ...
      skills: [
        { name: 'Figma', level: '상' },
        { name: 'Illustrator', level: '상' },
        { name: 'Framer', level: '중' },
        { name: 'User Research', level: '중' },
        { name: 'Prototyping', level: '상' },
      ],
      personality: { leadership: 7, creativity: 10, execution: 6, analytical: 5, communication: 8 },
      // current_situation: 'has_project_need_member',
  ...
  },
  {
    ...
    profile: {
      ...
      skills: [
        { name: 'Google Analytics', level: '상' },
        { name: 'SQL', level: '중' },
        { name: 'SEO', level: '상' },
        { name: 'Notion', level: '상' },
        { name: 'Photoshop', level: '중' },
      ],
      personality: { leadership: 7, creativity: 8, execution: 9, analytical: 7, communication: 9 },
  ...
  },
  {
    ...
    profile: {
      ...
      skills: [
        { name: 'Go', level: '상' },
        { name: 'Docker', level: '상' },
        { name: 'Kubernetes', level: '중' },
        { name: 'PostgreSQL', level: '상' },
        { name: 'AWS', level: '중' },
      ],
      personality: { leadership: 5, creativity: 5, execution: 9, analytical: 9, communication: 6 },
      // current_situation: 'has_project_need_member',
