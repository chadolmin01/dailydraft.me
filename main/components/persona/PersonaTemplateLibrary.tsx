      ...
      <div className="p-5 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            maxLength={80}
            disabled={saving}
            className="w-full h-10 text-sm text-txt-primary bg-surface-bg border border-border rounded-xl px-3 focus:outline-none focus:border-brand disabled:opacity-60"
          />
        ...
        <div>
          ...
          <textarea
            ...
            maxLength={500}
            disabled={saving}
            className="w-full text-sm text-txt-primary bg-surface-bg border border-border rounded-xl px-3 py-2.5 focus:outline-none focus:border-brand leading-relaxed resize-none disabled:opacity-60"
          />
        </div>
