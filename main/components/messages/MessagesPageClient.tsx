            ...
            <div className="p-4 border-b border-border/40">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="이름으로 검색..."
                  className="w-full pl-9 pr-3 py-2 text-base sm:text-sm border border-border bg-surface-bg ob-input rounded-xl"
                />
              </div>
            </div>
                            ...
                            <div className={`flex items-center gap-2 mt-1 ${isMine ? 'justify-end' : 'justify-start'}`}>
                              ...
                              {!isSending && !isFailed && !msg.id.startsWith('optimistic-') && (
                                <button
                                  ...
                                  title="이 메시지 삭제 · 상대방 화면에서도 함께 사라집니다"
                                  aria-label="메시지 삭제 · 상대방 화면에서도 제거됩니다"
                                >
                                  <Trash2 size={10} />
                                </button>
                              )}
                ...
                <div className="px-4 py-3 border-t border-border/40 shrink-0">
                  <div className="flex gap-2 items-end">
                    <textarea
                      ...
                      maxLength={2000}
                      rows={1}
                      className="flex-1 px-3 py-2.5 text-base sm:text-sm border border-border bg-surface-bg ob-input rounded-xl resize-none leading-relaxed"
                      style={{ maxHeight: 160 }}
                    />
                    <button
                      onClick={handleSend}
