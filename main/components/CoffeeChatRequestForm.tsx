  ...
  return (
    <div className="text-center py-4">
      ...
      <textarea
        ...
        rows={4}
        className="w-full px-4 py-3 border border-border rounded-sm text-sm text-left bg-surface-card rounded-lg focus:outline-none focus:border-brand resize-none mb-4"
      />
