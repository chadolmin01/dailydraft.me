    ...
    <div>
      ...
      <div className="flex gap-1.5">
        <input
          ...
          className="flex-1 px-3 py-1.5 text-sm border border-border bg-surface-card rounded-lg focus:outline-none focus:border-accent transition-colors"
        />
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              placeholder="예: 15"
              className="w-32 px-3 py-2 text-sm border border-border bg-surface-card rounded-lg focus:outline-none focus:border-accent transition-colors"
            />
