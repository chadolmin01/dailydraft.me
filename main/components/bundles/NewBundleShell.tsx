            ...
            <div key={f.name}>
              ...
              {f.type === 'textarea' ? (
                <textarea
                  ...
                  rows={3}
                  className="w-full text-sm text-txt-primary bg-surface-bg border border-border rounded-xl px-3 py-2 focus:outline-none focus:border-brand leading-relaxed resize-none"
                />
              ) : f.type === 'select' ? (
                <select
                  value={meta[f.name] ?? ''}
                  ...
                  className="w-full h-10 text-sm text-txt-primary bg-surface-bg border border-border rounded-xl px-3 focus:outline-none focus:border-brand"
                >
      ...
      <section className="bg-surface-card border border-border rounded-2xl p-5 space-y-5">
        ...
        <label className="block">
          ...
          <input
            ...
            className="w-full h-11 text-sm text-txt-primary bg-surface-bg border border-border rounded-xl px-3 focus:outline-none focus:border-brand"
          />
        </label>
