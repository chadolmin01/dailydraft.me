                      ...
                      return (
                        <div key={ch.id} className="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-surface-bg">
                          ...
                          <select
                            ...
                            className="flex-1 min-w-0 text-sm border border-border rounded-lg px-2 py-1.5 bg-surface-card text-txt-primary focus:outline-hidden focus:border-brand transition-colors"
                          >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={200}
                  className="w-full px-3 py-2.5 border border-border rounded-xl text-sm text-txt-primary bg-surface-card resize-none h-20 focus:outline-hidden focus:border-brand transition-colors placeholder:text-txt-disabled"
                />
