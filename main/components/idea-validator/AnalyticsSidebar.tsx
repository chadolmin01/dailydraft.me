  ...
  return (
    <div className="w-56 lg:w-64 bg-surface-card border-l border-border overflow-y-auto shrink-0 p-4 hidden md:block">
       ...
       <div className="mb-6 border border-border p-4 bg-surface-card rounded-xl">
         <div className="text-[10px] font-medium text-txt-tertiary mb-3">Current Session</div>
       ...
       <div className="flex items-center justify-between mb-5">
           <div className="flex items-center gap-2">
               ...
               <span className="text-[10px] font-medium text-txt-tertiary">Live Analysis</span>
           </div>
       </div>
          ...
          <div className="flex justify-between items-start mb-5">
              <div>
                  <div className="flex items-center gap-1.5 mb-1">
                    ...
                    <h3 className="text-[10px] font-medium text-txt-tertiary">AI Analysis</h3>
                  </div>
       ...
       {metrics && (
           <div className="space-y-5">
               <div>
                   <h4 className="text-[10px] font-medium text-txt-tertiary mb-2">Strengths</h4>
               ...
               <div>
                   <h4 className="text-[10px] font-medium text-txt-tertiary mb-2">Risks</h4>
                   <div className="space-y-1.5">
