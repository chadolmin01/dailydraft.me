...
const ResultView: React.FC<ResultViewProps> = ({
  ...
  const ActionCard = ({ title, items, color, icon }: { title: string, items: string[], color: string, icon: React.ReactNode }) => (
    <div className="bg-surface-card border border-border p-6 shadow-sharp hover:shadow-brutal transition-shadow">
    ...
    <div className="bg-surface-card shadow-brutal border border-border overflow-hidden mx-auto max-w-5xl">
      ...
      <div className="p-8 md:p-12 space-y-12">
         ...
         <section>
            ...
            <p className="text-txt-secondary leading-relaxed text-lg border-l-4 border-border-strong pl-4 bg-surface-sunken py-4 pr-4">
               {prd.overview}
            </p>
         </section>
         ...
         <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               {prd.coreFeatures.map((feature, i) => (
                  <div key={i} className="bg-surface-card border border-border p-5 hover:shadow-sharp transition-shadow">
         ...
         {/* Footer Note */}
         <div className="text-center text-xs text-txt-tertiary pt-8 border-t border-dashed border-border">
              ...
              <div className="bg-surface-sunken p-6 border border-border">
                 ...
                 <div className="flex flex-wrap gap-2">
                    {jd.preferred.map((skill, i) => (
                       <span key={i} className="px-3 py-1 bg-surface-card border border-border text-xs font-medium text-txt-secondary shadow-sharp">
                          {skill}
                       </span>
                    ))}
                 </div>
             ...
             <div className="flex items-center gap-3">
               {onComplete && (
                 <button
                   type="button"
                   onClick={onComplete}
                   className="px-5 py-3 bg-surface-card text-txt-secondary font-bold border border-border-strong hover:bg-black hover:text-white transition-colors flex items-center gap-2 text-sm"
                 >
                   완료
                 </button>
               )}
      ...
      <div className="grid grid-cols-12 gap-3 sm:gap-4 lg:gap-8 items-start">
        ...
        <div className="col-span-2">
            <div className="sticky top-6 space-y-1">
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 transition-all ${activeTab === 'overview' ? 'bg-surface-card border border-border shadow-sharp text-draft-black' : 'text-txt-tertiary hover:bg-surface-sunken hover:text-txt-primary'}`}
                >
                  <div className="flex items-center gap-3">
                    <Layout size={18} />
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 transition-all ${activeTab === 'prd' ? 'bg-surface-card border border-border shadow-sharp text-draft-black' : 'text-txt-tertiary hover:bg-surface-sunken hover:text-txt-primary'}`}
                >
                  <div className="flex items-center gap-3">
                    <FileText size={18} />
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 transition-all ${activeTab === 'jd' ? 'bg-surface-card border border-border shadow-sharp text-draft-black' : 'text-txt-tertiary hover:bg-surface-sunken hover:text-txt-primary'}`}
                >
                  <div className="flex items-center gap-3">
                    <Briefcase size={18} />
                ...
                <div className="pt-6 mt-2 border-t border-dashed border-border space-y-2 px-1">
        ...
        <div className="col-span-7">
           <div className="relative">
               ...
               {activeTab === 'overview' && (
                   <div className="animate-in fade-in duration-300 space-y-8 bg-surface-card border border-border p-8 md:p-12 shadow-sharp min-h-[50rem]">
                       <div>
