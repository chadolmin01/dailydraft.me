    ...
    <div className="mt-3 flex flex-wrap gap-1.5">
      {POSITION_OPTIONS.map((pos, idx) => (
        <button
          ...
          className="ob-chip ob-hover px-3.5 py-2 bg-surface-card rounded-xl border border-border text-[13px] font-medium text-txt-primary hover:bg-black hover:text-white"
