...
export const GreetingStep: React.FC<GreetingStepProps> = ({ onCtaClick }) => {
  return (
    <div className="mt-3">
      <button onClick={onCtaClick} className="ob-cta ob-hover inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-brand text-white text-[13px] font-bold hover:opacity-90 active:scale-[0.97] border border-brand">
