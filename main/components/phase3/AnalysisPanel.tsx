  ...
  return (
    <div className="w-72 h-full border-r border-border bg-surface-card flex flex-col flex-shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5">
        <div>
          <h3 className="text-[10px] font-medium text-txt-disabled mb-2 flex items-center gap-2">
            <Target size={12} />
            분해 전략
          </h3>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1.5">
            <span className="px-2 py-0.5 bg-surface-sunken text-txt-secondary text-[10px] border border-border">User Auth</span>
            <span className="px-2 py-0.5 bg-surface-sunken text-txt-secondary text-[10px] border border-border">Supabase</span>
            <span className="px-2 py-0.5 bg-surface-sunken text-txt-secondary text-[10px] border border-border">Payment</span>
          </div>
        </div>
      </div>

      <div className="p-3 border-t border-border bg-surface-sunken text-[10px] text-center text-txt-disabled">
