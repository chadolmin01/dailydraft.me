              ...
              <div className="flex flex-col gap-3 mb-3 flex-shrink-0">
                <div className="flex justify-between items-end">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <button aria-label="공유" className="w-6 h-6 border border-border flex items-center justify-center text-txt-disabled hover:border-border hover:text-txt-secondary transition-colors rounded-lg">
                      <Share2 size={12} />
                    </button>
