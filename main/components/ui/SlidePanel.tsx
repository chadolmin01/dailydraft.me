...
export const SlidePanel: React.FC<SlidePanelProps> = ({
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed top-0 right-0 z-modal h-full ${width} max-w-[calc(100vw-2rem)] bg-surface-bg border-l-2 border-border-strong shadow-brutal flex flex-col transition-transform duration-300 ease-out ${
