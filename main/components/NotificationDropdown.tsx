...
export function NotificationDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute right-0 top-11 w-[calc(100vw-2rem)] sm:w-96 max-w-[24rem] bg-surface-elevated border border-border shadow-brutal z-dropdown animate-in fade-in zoom-in-95 duration-150">
          {/* Header */}
