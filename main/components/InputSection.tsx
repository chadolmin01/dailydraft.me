  ...
  return (
    <div className="flex flex-col w-full bg-surface-card h-full">
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-surface-card relative flex flex-col gap-4">
        ...
        {/* 1. Text Input */}
        <div className="relative border border-border bg-surface-sunken focus-within:bg-surface-card rounded-xl focus-within:border-border focus-within:shadow-sharp transition-all duration-200 flex-shrink-0">
            <textarea
                value={activeInput}
        ...
        {roleLogs.length > 0 && (
            <div className="flex-1 flex flex-col min-h-0">
                ...
                <div ref={logContainerRef} className="overflow-y-auto flex-1 space-y-2 pr-1 custom-scrollbar">
                    {roleLogs.map((log) => (
                        <div key={log.id} className="group flex items-start gap-3 p-3 bg-surface-sunken rounded-xl border border-border hover:bg-surface-card rounded-xl hover:border-border hover:shadow-sharp transition-all">
