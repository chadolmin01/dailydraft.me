...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/help`, lastModified: new Date('2026-04-22'), changeFrequency: 'weekly', priority: 0.7 },
    ...
    { url: `${baseUrl}/legal`, lastModified: new Date('2026-04-22'), changeFrequency: 'monthly', priority: 0.4 },
    { url: `${baseUrl}/security`, lastModified: new Date('2026-04-22'), changeFrequency: 'monthly', priority: 0.5 },
    { url: `${baseUrl}/accessibility`, lastModified: new Date('2026-04-22'), changeFrequency: 'monthly', priority: 0.4 },
    { url: `${baseUrl}/contact`, lastModified: new Date('2026-04-22'), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${baseUrl}/enterprise`, lastModified: new Date('2026-04-22'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/about`, lastModified: new Date('2026-04-22'), changeFrequency: 'monthly', priority: 0.5 },
    { url: `${baseUrl}/press`, lastModified: new Date('2026-04-22'), changeFrequency: 'monthly', priority: 0.4 },
    { url: `${baseUrl}/brand`, lastModified: new Date('2026-04-22'), changeFrequency: 'monthly', priority: 0.3 },
    { url: `${baseUrl}/stats`, lastModified: new Date('2026-04-22'), changeFrequency: 'hourly', priority: 0.4 },
    ...
    { url: `${baseUrl}/legal/retention`, lastModified: new Date('2026-04-22'), changeFrequency: 'monthly', priority: 0.4 },
  ]
