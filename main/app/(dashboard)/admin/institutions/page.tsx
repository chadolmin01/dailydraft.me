            ...
            <form onSubmit={editingInst ? handleEditSubmit : handleCreateSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-3 py-2.5 bg-surface-sunken rounded-xl border border-border text-base sm:text-sm text-txt-primary placeholder:text-txt-disabled focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand transition-colors resize-none"
                />
              </div>
              <div>
