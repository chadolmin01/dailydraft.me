    ...
    <div className="bg-surface-bg min-h-full pb-20">
      ...
      <div id="layouts">
        ...
        <div className="border border-border mx-4 sm:mx-6 lg:mx-8 mb-8 overflow-hidden">
          ...
          >
            <div className="bg-surface-inverse/5 border border-border p-6 text-center min-h-50 flex flex-col items-center justify-center">
              <p className="text-sm font-medium text-txt-primary">Main Content</p>
      ...
      <PageContainer size="wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
          ...
          <div className="bg-surface-card rounded-xl border border-border overflow-hidden group hover:border-border hover:shadow-sharp transition-all cursor-pointer h-85 flex flex-col">
            {/* 헤더: 커버 — 고정 144px */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
          ...
          {/* 상태 1: OPEN — 팀 합류 가능 */}
          <div className="bg-surface-card rounded-xl border border-border overflow-hidden group hover:border-border hover:shadow-sharp transition-all cursor-pointer h-55 flex flex-col">
            {/* 헤더: 아바타 + 이름/역할 — 고정 */}
            ...
            <div className="p-5">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <button
                    key={i}
                    className={`w-full flex items-center gap-3 px-4 py-3 border text-left transition-all focus-visible:ring-2 focus-visible:ring-(--focus-ring) focus-visible:ring-offset-1 ${
                      i === 1
          ...
          <div className="bg-surface-card rounded-xl border border-border overflow-hidden">
            ...
            <div className="p-5">
              ...
              <div className="relative">
                <textarea
                  className="w-full h-28 px-4 py-3 text-base sm:text-sm text-txt-primary bg-surface-card rounded-lg border border-border resize-none focus:outline-hidden focus:border-accent focus:ring-2 focus:ring-(--focus-ring) transition-colors placeholder:text-txt-disabled"
      ...
      {tab === 'projects' && (
        <div className={viewMode === 'detail' ? 'grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'space-y-1'}>
          {projects.map((p) => viewMode === 'detail' ? (
            ...
            <div key={p.title} className="bg-surface-card rounded-xl border border-border overflow-hidden group hover:border-border hover:shadow-sharp transition-all cursor-pointer h-85 flex flex-col">
      ...
      {tab === 'people' && (
        <div className={viewMode === 'detail' ? 'grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'space-y-1'}>
          {people.map((p) => viewMode === 'detail' ? (
            ...
            <div key={p.name} className="bg-surface-card rounded-xl border border-border overflow-hidden group hover:border-border hover:shadow-sharp transition-all cursor-pointer h-55 flex flex-col">
              {/* 헤더: 아바타 + 이름/역할 */}
              <div className="px-4 pt-4 h-19 shrink-0">
                <div className="flex gap-3">
