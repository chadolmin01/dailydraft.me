    ...
    <div className="bg-[#FAFAFA] min-h-full pb-20">
      ...
      <PageContainer size="wide" className="pt-8 pb-6">
        <div className="flex items-end justify-between border-b border-gray-200 pb-6">
          <div>
            <p className="text-[10px] font-mono text-gray-400 uppercase tracking-widest mb-2">DRAFT DESIGN SYSTEM</p>
      ...
      <div id="layouts">
        ...
        <div className="border-y border-dashed border-blue-200 bg-blue-50/30 mb-1">
          <PageContainer size="narrow" className="py-4">
            <div className="bg-white border border-blue-200 rounded-xl p-4 text-center">
              <p className="text-[10px] font-mono text-blue-500 uppercase tracking-widest mb-1">narrow — 768px</p>
        ...
        <div className="border-y border-dashed border-green-200 bg-green-50/30 mb-1">
          <PageContainer size="standard" className="py-4">
            <div className="bg-white border border-green-200 rounded-xl p-4 text-center">
              <p className="text-[10px] font-mono text-green-500 uppercase tracking-widest mb-1">standard — 1200px</p>
        ...
        <div className="border-y border-dashed border-violet-200 bg-violet-50/30 mb-6">
          <PageContainer size="wide" className="py-4">
            <div className="bg-white border border-violet-200 rounded-xl p-4 text-center">
              <p className="text-[10px] font-mono text-violet-500 uppercase tracking-widest mb-1">wide — 1400px</p>
        ...
        <div className="space-y-1 mb-8">
          <Section spacing="sm" bg="white">
            <PageContainer size="standard">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-mono text-gray-400 uppercase">spacing=sm · bg=white</span>
          ...
          <Section spacing="md" bg="gray">
            <PageContainer size="standard">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-mono text-gray-400 uppercase">spacing=md · bg=gray</span>
          ...
          <Section spacing="lg" bg="white">
            <PageContainer size="standard">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-mono text-gray-400 uppercase">spacing=lg · bg=white</span>
        ...
        <div className="border border-dashed border-gray-300 rounded-xl mx-4 sm:mx-6 lg:mx-8 mb-4 overflow-hidden">
          <div className="bg-gray-100 px-4 py-2 border-b border-dashed border-gray-300">
            <span className="text-[10px] font-mono text-gray-500 uppercase">1-column — main only</span>
          </div>
        ...
        <div className="border border-dashed border-gray-300 rounded-xl mx-4 sm:mx-6 lg:mx-8 mb-4 overflow-hidden">
          <div className="bg-gray-100 px-4 py-2 border-b border-dashed border-gray-300">
            <span className="text-[10px] font-mono text-gray-500 uppercase">2-column — sidebar + main</span>
          </div>
          <DashboardLayout
            size="wide"
            sidebar={
        ...
        <div className="border border-dashed border-gray-300 rounded-xl mx-4 sm:mx-6 lg:mx-8 mb-8 overflow-hidden">
          <div className="bg-gray-100 px-4 py-2 border-b border-dashed border-gray-300">
            <span className="text-[10px] font-mono text-gray-500 uppercase">3-column — sidebar + main + aside</span>
          </div>
          <DashboardLayout
            size="wide"
            sidebar={
          ...
          >
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center min-h-[200px] flex flex-col items-center justify-center">
              <p className="text-xs font-medium text-blue-600">Main Content</p>
          ...
          <div className="flex gap-2 flex-wrap">
            {(['sm', 'md', 'lg', 'xl'] as const).map((s) => (
              <button
                ...
                className="px-4 py-2 text-xs font-semibold border border-gray-200 rounded-lg hover:bg-black hover:text-white hover:border-black transition-colors"
              >
                {s.toUpperCase()} 모달 열기
              </button>
            ))}
      ...
      <PageContainer size="wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3">카테고리</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3">바로가기</h3>
            <nav className="space-y-1">
              {[
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3">프로필 완성도</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3 flex items-center gap-1"><Flame size={10} /> 트렌딩</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-12">
          ...
          <div className="bg-white border border-amber-200 rounded-xl p-4 bg-amber-50/30">
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <input type="text" placeholder="연락처 입력" className="w-32 px-2 py-1 text-xs border border-gray-300 rounded-lg focus:outline-none focus:border-black" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4">
            ...
            <button className="w-full mt-4 flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-semibold border border-gray-200 rounded-lg hover:bg-black hover:text-white hover:border-black transition-colors">프로필 수정</button>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 group hover:border-gray-400 hover:shadow-sm transition-all cursor-pointer">
            <div className="flex flex-col items-center text-center">
              ...
              <span className="text-[10px] bg-amber-50 text-amber-600 px-1.5 py-0.5 rounded mt-2">프로젝트 1개 진행중</span>
            </div>
          </div>
        </div>
