          ...
          <div className="bg-surface-card rounded-xl border border-border overflow-hidden">
            ...
            <div className="p-5">
              ...
              <div className="relative">
                <textarea
                  className="w-full h-28 px-4 py-3 text-sm text-txt-primary bg-surface-card rounded-xl border border-border rounded-lg resize-none focus:outline-none focus:border-accent focus:ring-2 focus:ring-[var(--focus-ring)] transition-colors placeholder:text-txt-disabled"
