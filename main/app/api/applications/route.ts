...
export async function POST(request: Request) {
  try {
    ...
    // Get user profile and opportunity for match score
    ...
    // Check if trying to apply to own opportunity
    ...
    // Increment user's application usage count
    await incrementApplicationUsage(supabase, user.id)

    // Notify opportunity creator about new application
...
export async function GET(request: Request) {
  try {
    ...
    // Basic query - applications with opportunities
    ...
    if (type === 'sent') {
      ...
      // Get applications for opportunities I created
    ...
    // For received applications, fetch profile data separately
