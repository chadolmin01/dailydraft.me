  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-black">
      ...
      <div className="flex flex-col items-center mb-12">
        ...
        <h1 className="text-3xl font-bold text-white mb-2">Idea Snap</h1>
        <p className="text-gray-400 text-center">
          일상의 인사이트를 파편으로 저장하세요
        </p>
      </div>
      ...
      <div className="w-full max-w-sm space-y-3">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-black rounded-2xl font-medium text-lg transition-transform active:scale-[0.98]"
        >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-zinc-800 text-white rounded-2xl font-medium text-lg transition-transform active:scale-[0.98]"
        >
