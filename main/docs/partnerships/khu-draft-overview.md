...
운영진이 승인 버튼을 누르기 전까지는 어떤 글도 외부로 나가지 않습니다. 자동화라는 단어와 달리 실제로는 사람이 마지막에 개입하는 구조라고 생각하시면 될 것 같습니다.
...
센터 담당자용 뷰는 소속 동아리들의 활동량·멤버 변화·주간 리포트를 종합한 지표 화면입니다. 학기말 실적 보고에 곧바로 들어갈 수 있는 형태로 내려받을 수 있고, 개별 동아리의 운영진 변경·중요 결정 같은 이벤트도 감사 로그로 함께 쌓입니다. 본문 2부에서 말씀드린 "후속 기록 부족" 고민과 가장 직접 닿아 있는 화면이 이 쪽이라고 봅니다.

### 7. 학내 탐색

![학내 탐색 화면](./screenshots/05_explore.png)

학교 안에서 활동 중인 창업가·팀·동아리를 한 화면에서 탐색할 수 있습니다. 학내에서 실제로 움직이고 있는 학생이 누구인지 살펴볼 수 있는 화면 정도로 생각하고 있습니다.
