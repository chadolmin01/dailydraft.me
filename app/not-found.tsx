      ...
      <div className="max-w-md w-full text-center">
        <div className="border-2 border-border-strong bg-surface-card p-12 shadow-brutal">
          ...
          <div className="flex gap-3 justify-center">
            <Link
              href="/explore"
              className="px-6 py-2.5 bg-surface-inverse text-txt-inverse text-sm font-bold border border-black shadow-solid-sm hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] transition-all"
            >
              탐색하기
            </Link>
            <Link
