...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  return (
    <div
      className={cn(
        'w-full max-w-full px-5 sm:px-8 lg:px-16 xl:px-24 py-3 md:py-6',
        className
      )}
    >
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
        ...
        {sidebar && (
          <aside className="hidden lg:block lg:w-64 shrink-0 lg:sticky lg:top-14 lg:self-start lg:max-h-[calc(100vh-6.5rem)] lg:overflow-y-auto">
            {sidebar}
          </aside>
        )}
