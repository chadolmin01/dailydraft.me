...
export const PLAN_LIMITS = {
  [PLAN_TYPES.FREE]: {
    ...
    applicationDraftsPerMonth: 0, // AI 지원서 초안 불가
  },
  [PLAN_TYPES.PRO]: {
    ...
    applicationDraftsPerMonth: 10, // AI 지원서 초안 월 10회
  },
  [PLAN_TYPES.TEAM]: {
    ...
    applicationDraftsPerMonth: -1, // AI 지원서 초안 무제한
  },
} as const
...
export const SUBSCRIPTION_FEATURES = {
  ...
  // Phase 1: 시장 분석 기능
  MARKET_DEMAND_ANALYSIS: 'market_demand_analysis', // 시장 수요 분석
  EVENT_FIT_ANALYSIS: 'event_fit_analysis', // AI 이벤트 적합도 분석
  APPLICATION_DRAFT_GENERATION: 'application_draft_generation', // AI 지원서 초안 생성
} as const
...
export const FEATURE_REQUIREMENTS: Record<SubscriptionFeature, PlanType[]> = {
  ...
  // Phase 1: 시장 분석 기능 (Pro 이상)
  [SUBSCRIPTION_FEATURES.MARKET_DEMAND_ANALYSIS]: [PLAN_TYPES.PRO, PLAN_TYPES.TEAM],
  [SUBSCRIPTION_FEATURES.EVENT_FIT_ANALYSIS]: [PLAN_TYPES.PRO, PLAN_TYPES.TEAM],
  [SUBSCRIPTION_FEATURES.APPLICATION_DRAFT_GENERATION]: [PLAN_TYPES.PRO, PLAN_TYPES.TEAM],
}
