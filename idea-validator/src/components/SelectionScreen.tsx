...
const SelectionScreen: React.FC<SelectionScreenProps> = ({ onSelect }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full px-4 py-6 overflow-y-auto">
      <div className="w-full px-2">
        
        {!showLevelSelect ? (
          <div className="grid grid-cols-12 gap-4 sm:gap-6 lg:gap-12 items-center">
             {/* Left Text Area */}
             <div className="col-span-5 space-y-4 sm:space-y-6 lg:space-y-10 animate-in slide-in-from-left-4 duration-500">
             ...
             <div className="col-span-7 grid grid-cols-2 gap-2 sm:gap-3 lg:gap-6 animate-in slide-in-from-right-4 duration-500">
                <SelectionCard 
                  title="일반 등록 (Manual)"
