...
import { useOpportunities, calculateDaysLeft } from '../src/hooks/useOpportunities';
...
const featuredItems = [
  {
    ...
    image: 'bg-gray-900', // Removed gradients, went for solid/technical
