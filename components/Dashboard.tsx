...
// Updated Mock Data with clearer distinctions
const opportunities: Opportunity[] = [
  ...
  },
  {
    ...
    daysLeft: 30, // Available duration
    matchPercent: 92,
    category: '인재 추천'
  },
  {
...
// Mock Data for My Projects Carousel
const myProjects = [
  {
    id: 'p1',
    status: '진행중',
...
export const Dashboard: React.FC<DashboardProps> = ({ setActiveTab, events, onToggleEvent }) => {
  ...
  // Transform DB opportunities to UI format
  const transformOpportunity = (opp: OpportunityWithCreator): Opportunity => {
    ...
    return {
      ...
      daysLeft,
      matchPercent: 85, // TODO: Get from AI matching
  ...
  // Styles based on scope - Vivid Solid Colors Strategy
  ...
  // Filter incomplete tasks/events for the dashboard list
  ...
  return (
    <div className="flex-1 overflow-y-auto h-screen bg-[#FAFAFA] bg-grid-engineering relative flex flex-col">
      ...
      {/* Main Container: Flex Col to fill height */}
      <div className="max-w-[1600px] mx-auto p-8 lg:p-12 space-y-6 flex-1 flex flex-col w-full">
        ...
        <div className="flex-1 flex flex-col gap-3 min-h-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3 shrink-0">
            ...
            {/* 1. Left: Personal Profile Card (3 cols) */}
            <div className="col-span-12 md:col-span-3 flex flex-col gap-3">
              ...
              >
                ...
                <div className="p-5 flex flex-col h-full relative z-10">
                  ...
                  {/* Attribute Spec Sheet - Fills the empty space */}
            ...
            {/* 2. Center: Project Status & Team (6 cols) */}
            ...
            {/* 3. Right: Deadline & Upcoming Tasks (3 cols) */}
            <div className="col-span-12 md:col-span-3 flex flex-col gap-3">
              {/* Deadline Card - Black */}
              <Card 
              ...
              <div className="flex-1 bg-white border border-gray-200 p-4 rounded-sm flex flex-col hover:border-black transition-colors shadow-sm">
                <div className="flex justify-between items-center mb-4 border-b border-gray-100 pb-2">
                    ...
                    <button onClick={() => setActiveTab('calendar')} className="text-gray-400 hover:text-black"><Plus size={12}/></button>
                </div>
          ...
          {/* 4. Opportunity Index - Bottom Section */}
          <div className="flex flex-col gap-3">
             ...
             {/* Cards with fixed height to match Deadline Card approx ~150px */}
          ...
          {/* Footer - Fills remaining space and closes the view */}
