...
export const CalendarView: React.FC<CalendarViewProps> = ({ events, onAddEvent }) => {
  ...
  const [newEventDate, setNewEventDate] = useState('2026-02-13'); // Default date for demo
  ...
  // Filter only future deadlines for the sidebar list
  ...
  return (
    <div className="flex-1 overflow-y-auto h-screen bg-[#FAFAFA] bg-grid-engineering relative">
      {/* Container: Aligned with Dashboard/Explore (p-8 lg:p-12, max-w-[1600px]) */}
          ...
          <div className="xl:col-span-3 space-y-6">
             ...
             <div className="bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden">
                ...
                <div className="grid grid-cols-7">
                   ...
                   {/* Days */}
                   {days.map((day) => {
                      const isToday = day === 13; // Fixed for demo '2026-02-13'
