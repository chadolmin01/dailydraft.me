...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  const ActionButton = () => {
    ...
    const buttonClass = isCompact
      ? 'inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold bg-[#4F46E5] text-white border border-[#4F46E5] hover:bg-[#4338CA] transition-colors shadow-solid-sm hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px]'
      : 'inline-flex items-center gap-2 px-4 py-2.5 text-sm font-bold bg-[#4F46E5] text-white border border-[#4F46E5] hover:bg-[#4338CA] transition-colors shadow-solid-sm hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px]'
