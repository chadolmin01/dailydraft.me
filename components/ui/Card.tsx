...
export const Card: React.FC<CardProps> = ({ 
  ...
  const technicalClasses = "bg-gray-50/30 border border-dashed border-gray-300 hover:bg-white hover:border-gray-400";
    ...
    >
      {(title || action) && (
        <div className={`px-6 py-4 border-b border-gray-100 flex justify-between items-center`}>
          {title && <h3 className="font-sans font-bold text-gray-900 text-sm tracking-tight">{title}</h3>}
