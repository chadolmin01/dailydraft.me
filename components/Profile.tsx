  ...
  const analysisReports = [
    {
      ...
      theme: 'bg-[#0052CC] border-blue-900', // Draft Blue
    ...
    },
    {
      ...
      theme: 'bg-gray-900 border-black', // Dark
      textColor: 'text-white',
    ...
    },
    {
      ...
      theme: 'bg-[#059669] border-green-800', // Green
      textColor: 'text-white',
